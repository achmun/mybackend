			            	...
			            	<table class="table table-striped table-bordered table-hover" id="gridtable">
								<thead>
									<tr>
										...
										<th class="text-center">Adserver Affiliate ID</th>
										<th class="text-center">Analytics Source</th>
										<th class="text-center">GA View ID</th>
										<th></th>
									</tr>
								</thead>
								<tbody>
								...
								<?php //$dataParent = $this->sub_kategori_model->get_single_data(array("ID_KATEGORI"=>$val->ID_PARENT))?>
									<tr class="odd gradeX">
										...
										<td><?php echo $val->ox_affiliate_id == 0 ? "" : $val->ox_affiliate_id; ?></td>
										<td><?php echo $sources[$val->analytic_source]; ?></td>
										<td><?php echo $val->ga_view; ?></td>
