...
$publishers = array(''=>'');
foreach (get_publisher() as $val){
	$publishers[$val->id_pub] = $val->pub_name; 
}
$devices = array(
		''=>'',
		'Mobile' => 'Mobile',
...
<!-- 			            		<p class="text-primary">(*) is required.</p> -->
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<?php echo form_dropdown('publisher', $publishers, $datas['id_pub'], 'class="publisher col-md-12"')?>
									</div>
								</div>
								<div class="form-group">
									<?php //echo form_label('Nama Sub Kategori', 'sub_kategori', array('class'=>"col-sm-3 control-label"))?>
									<label for="kategori" class="col-sm-3 control-label">Website URL *</label>
									<div class="col-sm-9">
										<div class="input-group">
											<span class="input-group-addon" id="basic-addon1">http://</span> 
											<?php echo form_input(array('name' => 'website', 'class'=>'form-control', 'value'=>isset($_POST['website']) ? set_value('website') : $datas['website']))?>
										</div>
								...
								<div class="form-group">
									<?php //echo form_label('Nama Sub Kategori', 'sub_kategori', array('class'=>"col-sm-3 control-label"))?>
									<label for="kategori" class="col-sm-3 control-label">Layout Name *</label>
									<div class="col-xs-3">
						...
						<div class="panel-footer text-center">
							...
							<button type="button" class="btn btn-default" onclick="window.location='<?php echo base_url('zones')?>'">Cancel</button>
						</div>
					</div>
                </div>
			</div>
